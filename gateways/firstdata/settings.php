<?php
function event_espresso_firstdata_settings(){
...
<div class="postbox">
  ...
  <div class="padding">
  <?php
				if ($_REQUEST['activate_firstdata'] == 'true'){
				...
				if ($_REQUEST['reactivate_firstdata'] == 'true'){
					update_option( 'events_firstdata_active', 'true');
					//update_option( 'event_espresso_payment_gateway', 'paypal');
				}
				if ($_REQUEST['deactivate_firstdata'] == 'true'){
