			...
			<div class="inside">
				<div class="padding">
					...
					if (!empty($_REQUEST['activate_firstdata'])) {
						$active_gateways['firstdata'] = __DIR__;
					...
					if (array_key_exists('firstdata', $active_gateways)) {
						...
						echo '<li style="width:30%;" onclick="location.href=\'' . get_bloginfo('wpurl') . '/wp-admin/admin.php?page=payment_gateways&activate_firstdata=true\';" class="green_alert pointer"><strong>' . __('Activate First Data?', 'event_espresso') . '</strong></li>';
					}
					echo '</ul>';
					?>
				</div>
	...
	<form method="post" action="<?php echo $_SERVER['REQUEST_URI'] ?>">
		<table width="99%" border="0" cellspacing="5" cellpadding="5">
			<tr>
				...
				<td  valign="top">
					<span style="color:red"><?php echo __("Place the .pem file in the following folder.  Make sure the .pem file has the same name as your store number.", 'event_espresso') . ":<br /> " . __DIR__; ?></span><br /><br />
