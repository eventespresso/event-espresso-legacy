...
function espresso_display_firstdata($data) {
	...
	$return_url = espresso_build_gateway_url('return_url', $data, 'firstdata');
	...
	<div id="firstdata-payment-option-form-dv" class="hide-if-js">	
		<div class="event-display-boxes">
			...
			<div class = "event_espresso_form_wrapper">
				<form id="firstdata_payment_form" name="firstdata_payment_form" method="post" action="<?php echo $return_url;
		; ?>">
