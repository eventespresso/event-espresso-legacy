...
function espresso_display_firstdata($data) {
	...
	<div class="event-display-boxes">
		...
		<div class = "event_espresso_form_wrapper">
			<form id="firstdata_payment_form" name="firstdata_payment_form" method="post" action="<?php echo home_url() . '/?page_id=' . $org_options['notify_url'] . '&registration_id=' . $registration_id;; ?>">
				<p>
