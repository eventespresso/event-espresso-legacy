...
function espresso_display_firstdata($data) {
	...
	<div class="event-display-boxes">
		...
		<div class = "event_espresso_form_wrapper">
			<form id="firstdata_payment_form" name="firstdata_payment_form" method="post" action="<?php echo $home . '/?page_id=' . $org_options['return_url'] . '&registration_id=' . $registration_id;
	; ?>">
				<p>
				...
				<input name="firstdata_submit" id="firstdata_submit" class="btn_event_form_submit payment-submit" type="submit" value="<?php _e('Complete Purchase', 'event_espresso'); ?>" />
