...
//$image_url = $eway_settings['button_url'];
	...
	if ($eway_settings['force_ssl_return']) {
		...
		$myeway->addField('ReturnURL', $home . '/?page_id=' . $org_options['notify_url'] . '&id=' . $attendee_id . '&r_id=' . $registration_id . '&event_id=' . $event_id . '&attendee_action=post_payment&form_action=payment&type=eway');
