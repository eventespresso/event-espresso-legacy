			...
			<div class="inside">
				<div class="padding">
					...
					if (array_key_exists('eway', $active_gateways)) {
						...
						echo '<li style="width:30%;" onclick="location.href=\'' . get_bloginfo('wpurl') . '/wp-admin/admin.php?page=payment_gateways&activate_eway=true\';" class="green_alert pointer"><strong>' . __('Activate eway IPN?', 'event_espresso') . '</strong></li>';
					}
					echo '</ul>';
					?>
				</div>
