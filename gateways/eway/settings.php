...
function event_espresso_display_eway_settings() {
	...
	<div id="eway_sandbox_info" style="display:none">
		...
		<p><?php _e('In addition to using the eWay Sandbox feature. The debugging feature will also output the form varibales to the payment page, send an email to the admin that contains the all eWay variables.', 'event_espresso'); ?></p>
		<hr />
