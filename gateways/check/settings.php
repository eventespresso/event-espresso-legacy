			...
			<div class="inside">
				<div class="padding">
					...
					if (array_key_exists('check', $active_gateways)) {
						...
						echo '<li style="width:30%;" onclick="location.href=\'' . get_bloginfo('wpurl') . '/wp-admin/admin.php?page=payment_gateways&activate_check_payment=true\';" class="green_alert pointer"><strong>' . __('Activate Check/Money Order Payments?', 'event_espresso') . '</strong></li>';
					}
					echo '</ul>';
					?>
				</div>
	...
	<form method="post" action="<?php echo $_SERVER['REQUEST_URI'] ?>">
		<table width="90%" border="0">
			<tr>
				...
				<td valign="top">
					<ul>
						<li><label for="payable_to"><?php _e('Payable To:', 'event_espresso'); ?></label><br />
						...
						<li><label for="payment_address"><?php _e('Address to Send Payment:', 'event_espresso'); ?></label><br />
							<textarea name="payment_address" cols="30" rows="5">
								<?php echo $check_payment_settings['payment_address']; ?>
							</textarea>
						</li>
					</ul>
				</td>
