...
$attendees = $wpdb->get_results("SELECT * FROM ". EVENTS_ATTENDEE_TABLE ." WHERE id ='" . $_REQUEST['attendee_id'] . "'");
...
$pdf->Cell(50,5,$attendee_address,0,1,'L');//Set attendee address
$pdf->Cell(10,5,$attendee_city . ', ' . $attendee_state ,0,1,'L');//Set attendee address
$pdf->Cell(50,5,$attendee_zip,0,1,'L');//Set attendee zip 
$pdf->Ln(10);
