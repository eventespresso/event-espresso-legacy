...
// Setup payment page
	...
	if (isset($invoice_payment_settings['invoice_title'])) {
		...
		?>
		<p><a href="<?php echo home_url(); ?>/?invoice_type=<?php echo empty($invoice_type) ? '' : $invoice_type; ?>&amp;download_invoice=true&amp;attendee_id=<?php echo $attendee_id; ?>&amp;registration_id=<?php echo $registration_id ?>" class="inline-link"><?php _e('Download PDF Invoice', 'event_espresso'); ?></a></p>
		<?php
