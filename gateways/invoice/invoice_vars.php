...
<p><a href="<?php echo get_option('siteurl'); ?>/?downlaod_invoice=true&amp;attendee_id=<?php echo $attendee_id ?>&amp;registration_id=<?php echo $registration_id ?>" target="_blank"><?php _e('Download PDF Invoice', 'event_espresso'); ?></a></p>
