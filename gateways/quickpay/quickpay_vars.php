...
function espresso_display_quickpay($payment_data) {
	...
	$transact_url = $home . '/?page_id=' . $org_options['return_url'] . '&id=' . $attendee_id . '&registration_id=' . $registration_id . '&attendee_action=post_payment&form_action=payment&type=quickpay';
	...
	$transact_url = $home . '/?page_id=' . $org_options['notify_url'] . '&id=' . $attendee_id . '&registration_id=' . $registration_id . '&attendee_action=post_payment&form_action=payment&type=quickpay';
	$params = array('chronopay_callback' => 'true', 'transaction_id' => $transaction_id, 'sessionid' => $sessionid);
