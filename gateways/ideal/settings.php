			...
			<div class="inside">
				<div class="padding">
					...
					if (array_key_exists('ideal', $active_gateways)) {
						...
						echo '<li style="width:30%;" onclick="location.href=\'' . get_bloginfo('wpurl') . '/wp-admin/admin.php?page=payment_gateways&activate_ideal=true\';" class="green_alert pointer"><strong>' . __('Activate iDEAL (Mollie)?', 'event_espresso') . '</strong></li>';
					}
					echo '</ul>';
					?>
				</div>
