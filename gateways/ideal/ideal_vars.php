...
//Find the correct amount so that unsavory characters don't change it in the previous form
	...
	if (!$r || $wpdb->num_rows == 0) {
		...
		echo ("Looks like something went wrong.  Please try again or notify the website administrator.");
		return $payment_data;
	}
...
add_filter('filter_hook_espresso_transactions_get_payment_data', 'espresso_process_ideal');
