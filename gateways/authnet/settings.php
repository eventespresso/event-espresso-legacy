...
function event_espresso_authnet_payment_settings() {
	...
	if (isset($_POST['update_authnet'])) {
		...
		$authnet_settings['bypass_payment_page'] = empty($_POST['bypass_payment_page']) ? 'N':'Y';
			...
			<tr>
				...
				<td valign="top"><ul>
						<li>
							...
							<span class="display-path" style="background-color: rgb(255, 251, 204); border:#999 solid 1px; padding:2px;"><?php echo home_url() . '/?page_id=' . $org_options['return_url']; ?></span></li>
						<li>
