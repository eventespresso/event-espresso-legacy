			...
			<div class="inside">
				<div class="padding">
					...
					if (array_key_exists('exact', $active_gateways)) {
						echo '<li style="width:30%;" onclick="location.href=\'' . get_bloginfo('wpurl') . '/wp-admin/admin.php?page=payment_gateways&deactivate_exact=true\';" class="red_alert pointer"><strong>' . __('Deactivate E-xact Gateway?', 'event_espresso') . '</strong></li>';
							event_espresso_display_exact_settings();
					} else {
						echo '<li style="width:30%;" onclick="location.href=\'' . get_bloginfo('wpurl') . '/wp-admin/admin.php?page=payment_gateways&activate_exact=true\';" class="green_alert pointer"><strong>' . __('Activate E-xact Gateway?', 'event_espresso') . '</strong></li>';
					}
					echo '</ul>';
					?>
				</div>
				...
				<td valign="top"><ul>
						<li>
							<label for="exact_login_id">
								<?php _e('E-xact Login I.D.', 'event_espresso'); ?>
							</label>
							<br />
						...
						<li>
							...
							<a class="thickbox" href="#TB_inline?height=300&width=400&inlineId=exact_image_url_info"><img src="<?php echo EVENT_ESPRESSO_PLUGINFULLURL ?>/images/question-frame.png" width="16" height="16" /></a><br />
				...
				<td valign="top"><ul>
						...
						<li>
							<label for="use_sandbox">
								<?php _e('Is this an account on E-xact.com\'s development server?', 'event_espresso'); ?>
							</label>
							<input name="use_sandbox" type="checkbox" value="1" <?php echo $exact_settings['use_sandbox'] ? 'checked="checked"' : '' ?> />
							<a class="thickbox" href="#TB_inline?height=300&width=400&inlineId=exact_sandbox"><img src="<?php echo EVENT_ESPRESSO_PLUGINFULLURL ?>/images/question-frame.png" width="16" height="16" /></a> </li>
						<li>
							<label for="test_transactions">
								<?php _e('Do you want to submit a test transaction? ', 'event_espresso'); ?>
								<a class="thickbox" href="#TB_inline?height=300&width=400&inlineId=test_transactions"><img src="<?php echo EVENT_ESPRESSO_PLUGINFULLURL ?>/images/question-frame.png" width="16" height="16" /></a>
							</label>
