...
function espresso_display_paypal_pro($data) {
	...
	<div class="event-display-boxes">
		...
		<div class = "event_espresso_form_wrapper">
			<form id="paypal_pro_payment_form" name="paypal_pro_payment_form" method="post" action="<?php echo home_url() . '/?page_id=' . $org_options['return_url'] . '&registration_id=' . $registration_id; ?>">
				<p>
