...
function espresso_display_paypal_pro($data) {
	...
	<div class="event-display-boxes">
		...
		<div class = "event_espresso_form_wrapper">
			<form id="paypal_pro_payment_form" name="paypal_pro_payment_form" method="post" action="<?php echo $home . '/?page_id=' . $org_options['return_url'] . '&registration_id=' . $registration_id; ?>">
				<p>
	        ...
	        <input type="text" name="cvv" id="ppp_exp_date" />
				...
				<input name="paypal_pro_submit" id="paypal_pro_submit" class="btn_event_form_submit payment-submit" type="submit" value="<?php _e('Complete Purchase', 'event_espresso'); ?>" />
