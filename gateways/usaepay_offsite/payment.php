...
<?php	
	...
	echo "<input type=\"hidden\" name=\"UMredirApproved\" value=\"" . 
				add_query_arg(array('id'=>$attendee_id,'r_id'=>$registration_id,'event_id'=>$event_id,'attendee_action'=>'post_payment','form_action'=>'payment','type'=>'usaepay_offsite'),  apply_filters('espresso_filter_permalink', get_permalink($org_options['return_url']), $org_options['return_url'])) . "\"/>\n";
