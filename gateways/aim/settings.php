<?php 
function event_espresso_authnet_aim_settings(){
    ...
    <tr>
      <td valign="top"><ul>
          ...
          <?php /*?><li>
            ...
            <br />
            <input type="text" name="button_url" size="35" value="<?php echo (($authnet_aim_settings['button_url'] == '') ? $button_url : $authnet_aim_settings['button_url'] ) ;?>" />
            ...
            <a class="ev_reg-fancylink" href="#button_image"><img src="<?php echo EVENT_ESPRESSO_PLUGINFULLURL?>/images/question-frame.png" width="16" height="16" /></a></li><?php */?>
...
event_espresso_authnet_aim_settings();