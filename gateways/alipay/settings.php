		...
		<div class="postbox <?php echo $postbox_style; ?>">
			...
			<div class="inside">
				...
				if (!empty($_REQUEST['activate_alipay'])) {
					$active_gateways['alipay'] = __DIR__;
				...
				if (array_key_exists('alipay', $active_gateways)) {
					...
					echo '<li style="width:30%;" onclick="location.href=\'' . get_bloginfo('wpurl') . '/wp-admin/admin.php?page=payment_gateways&activate_alipay=true\';" class="green_alert pointer"><strong>' . __('Activate Alipay Gateway?', 'event_espresso') . '</strong></li>';
				}
				echo '</ul>';
				?>
			</div>
