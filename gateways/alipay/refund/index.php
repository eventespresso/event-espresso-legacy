...
<body>
		...
		<form name="alipaysubmit" enctype="multipart/form-data"  target="_blank" method="post" action="https://www.alipay.com/cooperate/gateway.do?">	
		   <input type="hidden" name="_input_charset" value="<? echo $parameter['_input_charset'] ?>">
			<input type="hidden" name="partner" value="<? echo $parameter['partner'] ?>">
			<input type="hidden" name="service" value="forex_refund_file">
			<input type="hidden" name="sign" value="<? echo $alipay->signParams() ?>"> 
