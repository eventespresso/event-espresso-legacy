...
<?php } ?>
		...
		<div class = "event_espresso_form_wrapper">
	        ...
	        <input type="text" name="cvv" id="ppp_exp_date" />
				...
				<input name="usaepay_onsite_submit" id="usaepay_onsite_submit" class="btn_event_form_submit payment-submit" type="submit" value="<?php _e('Complete Purchase', 'event_espresso'); ?>" />
		...
		<script>
			jQuery(function(){
				...
				jQuery('#usaepay_onsite_payment_form').validate();

				jQuery('#usaepay_onsite_payment_form').submit(function(){

					if (jQuery('#usaepay_onsite_payment_form').valid()){
						jQuery('#processing').html('<img src="' + EEGlobals.plugin_url + 'images/ajax-loader.gif">');
						//jQuery(':input[name="usaepay_onsite_submit"]').attr('disabled', 'disabled');
					}
