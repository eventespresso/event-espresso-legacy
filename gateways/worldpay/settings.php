...
function event_espresso_display_worldpay_settings() {
	...
	<div id="worldpay_sandbox_info" style="display:none">
		...
		<p><?php _e('In addition to using the WorldPay Sandbox feature. The debugging feature will also output the form variablesto the payment page, send an email to the admin that contains the all WorldPay variables.', 'event_espresso'); ?></p>
		<hr />
