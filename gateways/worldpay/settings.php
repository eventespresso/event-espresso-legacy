			...
			<div class="inside">
				<div class="padding">
					...
					if (!empty($_REQUEST['activate_worldpay'])) {
						$active_gateways['worldpay'] = __DIR__;
					...
					if (array_key_exists('worldpay', $active_gateways)) {
						...
						echo '<li style="width:30%;" onclick="location.href=\'' . get_bloginfo('wpurl') . '/wp-admin/admin.php?page=payment_gateways&activate_worldpay=true\';" class="green_alert pointer"><strong>' . __('Activate worldpay IPN?', 'event_espresso') . '</strong></li>';
					}
					echo '</ul>';
					?>
				</div>
