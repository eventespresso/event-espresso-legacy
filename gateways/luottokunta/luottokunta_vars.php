...
function espresso_display_luottokunta($payment_data) {
	...
	$base_return_url = espresso_build_gateway_url('return_url', $payment_data, 'luottokunta', array('order_id' => $order_id));
	$success_url = add_query_arg('success', true, $base_return_url);
	$failure_url = add_query_arg('success', 0, $base_return_url);
	$cancel_url = espresso_build_gateway_url('cancel_return', $payment_data, 'luottokunta');
