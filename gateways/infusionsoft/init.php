...
event_espresso_require_gateway("infusionsoft/infusionsoft_vars.php");

// This is for the thank you page to process the transaction
if (!empty($_REQUEST['infusionsoft_payment'])) {
	event_espresso_require_gateway("infusionsoft/infusionsoft_ipn.php");
	add_filter('filter_hook_espresso_transactions_get_attendee_id', 'espresso_transactions_infusionsoft_get_attendee_id');
	add_filter('filter_hook_espresso_thank_you_get_payment_data', 'espresso_process_infusionsoft');
}