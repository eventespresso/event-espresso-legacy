...
function espresso_display_paytrace($payment_data) {
	...
	<div class="event-display-boxes">
		...
		<div class = "event_espresso_form_wrapper">
			<form id="paytrace_payment_form" name="paytrace_payment_form" method="post" action="<?php echo home_url() . '/?page_id=' . $org_options['notify_url'] . '&registration_id=' . $registration_id; ?>">
				<p>
				...
				<p>
					...
					<input id="cvv" type="text" name="csc" />
				</p>
