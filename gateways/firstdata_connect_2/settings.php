...
function event_espresso_display_firstdata_connect_2_settings() {
	...
	<div id="sandbox_info_firstdata_connect_2" style="display:none">
		...
		<p><?php _e('In addition to using the First Data Sandbox feature. The debugging feature will also output the form varibales to the payment page, send an email to the admin that contains the all First Data variables.', 'event_espresso'); ?></p>
		<hr />
