...
class Fdggutil {
	...
	private function submitForm() {
		...
		$out .= '<input size="50" type="hidden" name="responseSuccessURL" value="' . home_url() . '/?page_id=' . $this->returnUrl . '&id=' . $this->attendee_id . '&registration_id=' . $this->registration_id . '"/>';
		$out .= '<input size="50" type="hidden" name="responseFailURL" value="' . home_url() . '/?page_id=' . $this->cancelUrl . '&id=' . $this->attendee_id . '&registration_id=' . $this->registration_id . '"/>';
		return $out;
	}
