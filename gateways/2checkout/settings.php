...
function event_espresso_display_2checkout_settings() {
	...
	<div id="sandbox_info" style="display:none">
		...
		<p><?php _e('In addition to using the 2Checkout Sandbox feature. The debugging feature will also output the form variablesto the payment page, send an email to the admin that contains the all 2Checkout variables.', 'event_espresso'); ?></p>
		<hr />
