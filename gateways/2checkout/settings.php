			...
			<div class="inside">
				<div class="padding">
					...
					if (!empty($_REQUEST['activate_2checkout'])) {
						$active_gateways['2checkout'] = __DIR__;
					...
					if (array_key_exists('2checkout', $active_gateways)) {
						...
						echo '<li style="width:30%;" onclick="location.href=\'' . get_bloginfo('wpurl') . '/wp-admin/admin.php?page=payment_gateways&activate_2checkout=true\';" class="green_alert pointer"><strong>' . __('Activate 2checkout IPN?', 'event_espresso') . '</strong></li>';
					}
					echo '</ul>';
					?>
				</div>
			...
			<tr>
				<td valign="top"><ul>
						<li>
							...
							<br />
							<input type="text" name="2checkout_id" size="35" value="<?php echo $twocheckout_settings['2checkout_id']; ?>">
							<br />
						...
						<li>
							...
							<br />
							<input type="text" name="2checkout_username" size="35" value="<?php echo $twocheckout_settings['2checkout_username']; ?>">
							<br />
				...
				<td valign="top"><ul>
						...
						<li>
							<label for="use_sandbox">
								<?php _e('Use the debugging feature and the', 'event_espresso'); ?> <a href="https://www.2checkout.com/va/signup/create_activation" target="_blank"><?php _e('2checkout Sandbox', 'event_espresso'); ?></a>?
							</label>
