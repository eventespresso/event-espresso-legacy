...
class Stripe_ChargeTest extends UnitTestCase
{
  ...
  {
    $this->assertEqual(Espresso_Stripe_Charge::classUrl('Stripe_Charge'), '/charges');
    $charge = new Espresso_Stripe_Charge('abcd/efgh');
    $this->assertEqual($charge->instanceUrl(), '/charges/abcd%2Fefgh');
  }

  public function testToString()
  {
    $charge = new Espresso_Stripe_Charge('a');
  ...
  {
    authorizeFromEnv();
    $c = Espresso_Stripe_Charge::create(array('amount' => 100,
				    'currency' => 'usd',
  ...
  public function testRetrieve()
  {
    ...
    $c = Espresso_Stripe_Charge::create(array('amount' => 100,
				    ...
				    'card' => array('number' => '4242424242424242',
						    'exp_month' => 5,
						    'exp_year' => 2015)));
    $d = Espresso_Stripe_Charge::retrieve($c->id);
