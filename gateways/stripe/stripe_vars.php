...
function espresso_display_stripe($payment_data) {
	...
	<div class="event-display-boxes">
		...
		<div class = "event_espresso_form_wrapper">
			<form id="stripe_payment_form" name="stripe_payment_form" method="post" action="<?php echo home_url() . '/?page_id=' . $org_options['return_url'] . '&registration_id=' . $registration_id; ?>">
				<p>
