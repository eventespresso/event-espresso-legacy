...
<?php	
	...
	if (file_exists(EVENT_ESPRESSO_GATEWAY_DIR . "/index.php")){
        ...
        <div class="box-mid-body" id="toggle6">
          <div class="padding">
          <p>
                <?php _e("Modifying and adding payment gateways is easy.");?>
              </p>
              <p>
...
<?php
			  if($_SESSION['event_espresso_gateways_copied'] == true) {
					...
					<div class="updated fade below-h2" id="message" style="background-color: rgb(255, 251, 204);">
						<p><?php _e("Your gateways have been moved."); ?></p>
					</div>
					<?php
...
<?php
				...
				?>
                	<p><?php _e('If you plan on adding additional payment gateways. Please use the link below to move your gateway files to a safe place.', 'event_espresso'); ?></p>
