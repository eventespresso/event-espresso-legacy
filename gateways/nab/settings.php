			...
			<div class="inside">
				<div class="padding">
					...
					if (array_key_exists('nab', $active_gateways)) {
						...
						echo '<li style="width:30%;" onclick="location.href=\'' . get_bloginfo('wpurl') . '/wp-admin/admin.php?page=payment_gateways&activate_nab=true\';" class="green_alert pointer"><strong>' . __('Activate NAB Transact Direct Post?', 'event_espresso') . '</strong></li>';
					}
					echo '</ul>';
					?>
				</div>
