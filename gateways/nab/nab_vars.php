...
function espresso_display_nab($payment_data) {
	...
	<form method="post" action="<?php echo $nab_post_url; ?>">
		...
		<input type="hidden" name="EPS_FIRSTNAME" value="<?php echo $fname; ?>">
		<input type="hidden" name="EPS_LASTNAME" value="<?php echo $lname; ?>">
		<input type="hidden" name="EPS_ZIPCODE" value="<?php echo $zip; ?>">
		<input type="hidden" name="EPS_TOWN" value="<?php echo $city; ?>">
		<input type="hidden" name="EPS_EMAILADDRESS" value="<?php echo $attendee_email; ?>">
		<table>
			<tbody>
				<tr>
