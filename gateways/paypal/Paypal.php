 ...
 * @package		Advanced Events Registration PayPal Gateway
 * @category	Library
 */
...
class Paypal extends PaymentGateway{
	...
	public function validateIpn()
	{
		...
		if (function_exists('curl_init')) {
			...
			//$orgoptions['godaddy_hosting'] == 'Y' ? curl_setopt($ch, CURL_PROXY_STATUS, false):'';
			curl_setopt($ch, CURL_PROXY_STATUS, false);
