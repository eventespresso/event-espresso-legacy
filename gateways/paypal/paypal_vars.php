...
// Setup class
			...
			$myPaypal->addField('item_name', $event_name . ' | '.__('Name:','event_espresso').' '. $fname . ' ' . $lname .' | '.__('Registrant Email:','event_espresso').' '.$attendee_email.' | '.__('Total Registrants:','event_espresso').' '.espresso_count_attendees_for_registration($attendee_id));
