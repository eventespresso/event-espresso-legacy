...
function organization_config_mnu() {
	...
	if (isset($_POST['update_org'])) {
		...
		$org_options['email_before_payment'] = isset($_POST['email_before_payment']) && $_POST['email_before_payment'] === 'Y' ? 'Y' : 'N';
		$org_options['email_fancy_headers'] = isset($_POST['email_fancy_headers']) && $_POST['email_fancy_headers'] === 'Y' ? 'Y' : 'N';
		$org_options['use_captcha'] = isset($_POST['use_captcha']) && $_POST['use_captcha'] === 'Y' ? 'Y' : 'N';
		...
		$org_options['skip_confirmation_page'] = isset($_POST['skip_confirmation_page']) && $_POST['skip_confirmation_page'] === 'Y' ? 'Y' : 'N';
		$org_options['allow_mer_discounts'] = isset($_POST['allow_mer_discounts']) && $_POST['allow_mer_discounts'] === 'Y' ? 'Y' : 'N';
		$org_options['allow_mer_vouchers'] = isset($_POST['allow_mer_vouchers']) && $_POST['allow_mer_vouchers'] === 'Y' ? 'Y' : 'N';
		$org_options['use_attendee_pre_approval'] = isset($_POST['use_attendee_pre_approval']) && $_POST['use_attendee_pre_approval'] === 'Y' ? 'Y' : 'N';
		if (!empty($_POST['event_ssl_active']))
			$org_options['event_ssl_active'] = isset($_POST['event_ssl_active']) && $_POST['event_ssl_active'] === 'Y' ? 'Y' : 'N';
		$org_options['show_pending_payment_options'] = isset($_POST['show_pending_payment_options']) && $_POST['show_pending_payment_options'] === 'Y' ? 'Y' : 'N';
		$org_options['use_venue_manager'] = isset($_POST['use_venue_manager']) && $_POST['use_venue_manager'] === 'Y' ? 'Y' : 'N';
		$org_options['use_personnel_manager'] = isset($_POST['use_personnel_manager']) && $_POST['use_personnel_manager'] === 'Y' ? 'Y' : 'N';
		$org_options['use_event_timezones'] = isset($_POST['use_event_timezones']) && $_POST['use_event_timezones'] === 'Y' ? 'Y' : 'N';
		$org_options['full_logging'] = isset($_POST['full_logging']) && $_POST['full_logging'] === 'Y' ? 'Y' : 'N';
