...
function organization_config_mnu() {
	...
	if (isset($_POST['update_org'])) {
		...
		$org_options['email_before_payment'] = isset($_POST['email_before_payment']) && !empty($_POST['email_before_payment']) ? sanitize_text_field($_POST['email_before_payment']) : '';
		$org_options['email_fancy_headers'] = isset($_POST['email_fancy_headers']) && !empty($_POST['email_fancy_headers']) ? sanitize_text_field($_POST['email_fancy_headers']) : '';
		$org_options['use_captcha'] = isset($_POST['use_captcha']) && !empty($_POST['use_captcha']) ? sanitize_text_field($_POST['use_captcha']) : '';
		...
		$org_options['time_reg_limit'] = isset($_POST['time_reg_limit']) && !empty($_POST['time_reg_limit']) ? sanitize_text_field($_POST['time_reg_limit']) : '';
		$org_options['skip_confirmation_page'] = isset($_POST['skip_confirmation_page']) ? sanitize_text_field($_POST['skip_confirmation_page']) : 'N';
		$org_options['allow_mer_discounts'] = isset($_POST['allow_mer_discounts']) ? sanitize_text_field($_POST['allow_mer_discounts']) : 'N';
		$org_options['allow_mer_vouchers'] = isset($_POST['allow_mer_vouchers']) ? sanitize_text_field($_POST['allow_mer_vouchers']) : 'N';
		$org_options['use_attendee_pre_approval'] = isset($_POST['use_attendee_pre_approval']) && !empty($_POST['use_attendee_pre_approval']) ? sanitize_text_field($_POST['use_attendee_pre_approval']) : '';
		if (!empty($_POST['event_ssl_active']))
			$org_options['event_ssl_active'] = isset($_POST['event_ssl_active']) && !empty($_POST['event_ssl_active']) ? sanitize_text_field($_POST['event_ssl_active']) : '';
		$org_options['show_pending_payment_options'] = isset($_POST['show_pending_payment_options']) && !empty($_POST['show_pending_payment_options']) ? sanitize_text_field($_POST['show_pending_payment_options']) : '';
		$org_options['use_venue_manager'] = isset($_POST['use_venue_manager']) && !empty($_POST['use_venue_manager']) ? sanitize_text_field($_POST['use_venue_manager']) : '';
		$org_options['use_personnel_manager'] = isset($_POST['use_personnel_manager']) && !empty($_POST['use_personnel_manager']) ? sanitize_text_field($_POST['use_personnel_manager']) : '';
		$org_options['use_event_timezones'] = isset($_POST['use_event_timezones']) && !empty($_POST['use_event_timezones']) ? sanitize_text_field($_POST['use_event_timezones']) : '';
		$org_options['full_logging'] = isset($_POST['full_logging']) && !empty($_POST['full_logging']) ? sanitize_text_field($_POST['full_logging']) : '';
		$org_options['surcharge'] = isset($_POST['surcharge']) && !empty($_POST['surcharge']) ? sanitize_text_field($_POST['surcharge']) : '';
		$org_options['surcharge_type'] = isset($_POST['surcharge_type']) && !empty($_POST['surcharge_type']) ? sanitize_text_field($_POST['surcharge_type']) : '';
		$org_options['surcharge_text'] = isset($_POST['surcharge_text']) && !empty($_POST['surcharge_text']) ? sanitize_text_field($_POST['surcharge_text']) : '';
		$org_options['show_reg_footer'] = isset($_POST['show_reg_footer']) && !empty($_POST['show_reg_footer']) ? sanitize_text_field($_POST['show_reg_footer']) : '';
		$org_options['affiliate_id'] = isset($_POST['affiliate_id']) && !empty($_POST['affiliate_id']) ? sanitize_text_field($_POST['affiliate_id']) : '';
		...
		$org_options['ticket_reservation_time'] = isset($_POST['ticket_reservation_time']) && !empty($_POST['ticket_reservation_time']) ? sanitize_text_field($_POST['ticket_reservation_time']) : '30';
		$ueip_optin = isset($_POST['ueip_optin']) && !empty($_POST['ueip_optin']) ? $_POST['ueip_optin'] : 'yes';

		$org_options['default_logo_url'] = isset($_REQUEST['upload_image']) && !empty($_REQUEST['upload_image']) ? sanitize_text_field($_REQUEST['upload_image']) : '';
