...
<?php 
	if (file_exists(EVENT_ESPRESSO_PLUGINFULLPATH . 'includes/admin-files/recaptcha_form.php') || file_exists(EVENT_ESPRESSO_PLUGINFULLPATH . 'includes/admin-files/template_files.php')  || file_exists(EVENT_ESPRESSO_PLUGINFULLPATH . 'includes/admin-files/optional_event_settings.php')){
		...
		echo '<li>' . __('Purchase a', 'event_espresso') . '<a href="http://eventespresso.com/download/" target="_blank">'.__('support license', 'event_espresso').'</a>'. __('to gain access to adavanced features such as CAPTCHA and', 'event_espresso') . '<a href="http://eventespresso.com/features/customizable-event-listings/" target="_blank">'.__('Template Customization', 'event_espresso').'</a>.</li>';
	}
?>  
      </ul>
