...
$category_id= $_REQUEST['category_id'];
	...
	<div id="message" class="updated fade"><p><strong>The category <?php echo stripslashes(htmlentities2($_REQUEST['category_name']));?> has been updated.</strong></p></div>
<?php }else { ?>
	<div id="message" class="error"><p><strong>The category <?php echo stripslashes(htmlentities2($_REQUEST['category_name']));?> was not updated. <?php print mysql_error() ?>.</strong></p></div>
