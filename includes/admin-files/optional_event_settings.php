         ...
         <li>
          ...
          <li>
            ...
            <div id="affiliate_info" class="pop-help" style="display:none">
                          ...
                          <p>Get paid by helping other event mangers understand the power of Event Espresso by becoming an affiliate.</p><ol><li>Go to the <a href="http://eventespresso.com/wp-content/plugins/wp-affiliate-platform/affiliates/register.php?utm_source=ee_plugin_admin&utm_medium=link&utm_content=Promote+Event+Espresso<?php echo '+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url(); ?>&utm_campaign=general_settings_tab" target="_blank">affiliate sign up page</a> to get your affiliate link</li><li>All affiliates get 20% from each sale</li><li>Payments are made only through paypal</li><li>Payments are sent at the beginning of each month for the sales of  the previous month</li><li>Payments will be made regardless of the sales volume. There is no  minimum limit</li><li>You can create your own banner or use the ones below</li></ol>
                        <p>
                            <a href="http://eventespresso.com/affiliates/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=Banners+and+More+Info<?php echo '+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url(); ?>&utm_campaign=general_settings_tab" target="_blank"><?php _e('Banners and More Info >>', 'event_espresso'); ?></a>
                          </p>
                        </div>
          </li>
        </ul>
