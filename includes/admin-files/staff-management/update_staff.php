...
function update_event_staff(){
	...
	$staff_meta['first_name'] = esc_html($_REQUEST['first_name']);
	$staff_meta['last_name'] = esc_html($_REQUEST['last_name']);
	...
	$staff_meta['linkedin'] = $_REQUEST['linkedin'];
	...
	$name = $staff_meta['first_name'] . ' ' . $staff_meta['last_name'];
	if ($name==' '){
