...
function edit_event_venue(){
	...
	foreach ($results as $result){
		...
		$locale=stripslashes_deep($result->locale);
          ...
          <tr>
            <td align="left" valign="top"><ul>
                ...
                <li>
                  ...
                  <input type="text" name="locale" size="25" value="<?php echo $locale;?>"> <a class="ev_reg-fancylink" href="#venue_locale"><img src="<?php echo EVENT_ESPRESSO_PLUGINFULLURL?>/images/question-frame.png" width="16" height="16" /></a>
                </li>
              </ul></td>
            <td align="left" valign="top"><ul>
                <li>
