...
function ee_core_load_pue_update() {
	...
	if (file_exists(EVENT_ESPRESSO_PLUGINFULLPATH . 'class/pue/pue-client.php')) { //include the file 
			...
			$api_key = isset( $org_options['site_license_key'] ) ? $org_options['site_license_key'] : ''; // TEMP FIX by brent - if this conflicts with any fix Darren's made - plz choose Darren's 
