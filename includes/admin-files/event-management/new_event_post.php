<div style="display: block;" id="event-post" class="postbox">
    ...
    <div class="inside">
        ...
        ?>
        <p class="create-post"><label><?php _e('Author', 'event_espresso'); ?>: </label><span> <?php wp_dropdown_users(array('who' => 'authors', 'selected' => $current_user->ID)); ?></span></p>
        <p class="create-post"><label><?php _e('Post Type', 'event_espresso'); ?>:</label> <span><?php echo select_input('espresso_post_type', $post_types, 'espresso_event') ?></span></p>
