...
<a class="thickbox"
			...
			echo select_input('use_coupon_code', $coupon_code_select_values, !isset($use_coupon_code) || $use_coupon_code == '' ? apply_filters('FHEE_default_use_coupon_code_value',$org_options['default_promocode_usage']) : $use_coupon_code);
			?>
