...
<div id="event-questions" class="postbox event-questions-lists">
	...
	<div class="inside">
		...
		<?php
            ...
            if ($espresso_premium != true)
                echo __('Need more questions?', 'event_espresso') . ' <a href="http://eventespresso.com/pricing/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=Need+more+questions+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url().'&utm_campaign=create_event_tab" target="_blank">' . __('Upgrade Now!', 'event_espresso') . '</a>';
