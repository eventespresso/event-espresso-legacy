...
else
{
		...
		$sql=array('event_name'=>$event_name, 'event_desc'=>$event_desc, 'display_desc'=>$display_desc, 'display_reg_form'=>$display_reg_form, 'event_identifier'=>$event_identifier,
				   ...
				   'early_disc' => $early_disc, 'early_disc_date' => $early_disc_date, 'early_disc_percentage' => $early_disc_percentage, 'alt_email' => $alt_email, 
				    'question_groups' => $question_groups, 'reg_limit'=>$reg_limit, 'additional_limit'=>$additional_limit, 'recurrence_id'=>$recurrence_id, 'email_id' => $email_id);
		...
		if ($_REQUEST['create_post'] == 'Y'){
			...
			if ($post_type =='post'){
				...
				add_post_meta( $post_id, 'event_registration_start', $_REQUEST['registration_start'] );
				add_post_meta( $post_id, 'event_registration_end', $_REQUEST['registration_end'] );
