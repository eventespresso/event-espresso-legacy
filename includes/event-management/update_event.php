    ...
    if ( $_REQUEST['event_cost'] != '' )
    {
        foreach ( $_REQUEST['event_cost'] as $k => $v ) {
            if ( $v != '' )
            {
                ...
                $sql_prices = "INSERT INTO " . EVENTS_PRICES_TABLE . " (event_id, event_cost, surcharge, price_type, member_price, member_price_type) VALUES ('" . $event_id . "', '" . $v . "', '" . $_REQUEST['surcharge'][$k] . "', '" . $price_type . "', '" . $member_price . "', '" . $member_price_type . "')";
                //echo "$sql_prices <br>";
