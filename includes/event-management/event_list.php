...
<ul class="subsubsub">
    ...
    <li><a <?php echo $_REQUEST[ 'this_month' ]=='true'? ' class="current" ':''?>  href="admin.php?page=events&this_month=true"><?php _e('This Month', 'event_espresso'); ?> <span class="count">(<?php echo $total_events_this_month ?>)</span></a> <?php /*?>|</li>
     <li><a href="admin.php?page=events&event_admin_reports=event_list_attendees"><?php _e('All Attendees', 'event_espresso'); ?> <span class="count">(<?php echo get_number_of_attendees_reg_limit(0, 'all_attendees') ?>)</span></a><?php */?></li>
</ul>
