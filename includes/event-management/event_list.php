	...
	if ($total_events > 0) {
		...
		if ($total_events > 500) {
			...
			<form method="post" action="admin.php?page=events">
				<p><span style="color: red;"><?php _e('You have more than 500 records.'); ?></span>
		...
		<div style="clear:both; margin-bottom:30px;">
			...
			<?php } else { ?>
				...
				<a style="margin-left:5px" class="button-secondary" href="admin.php?page=espresso_attendee_import"><?php _e('Import Attendees', 'event_espresso'); ?></a>
