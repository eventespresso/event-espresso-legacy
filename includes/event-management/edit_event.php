...
<?php _e('Add a pre-populated <a href="admin.php?page=form_groups" target="_blank">group</a> of <a href="admin.php?page=form_builder" target="_blank">questions</a> to your event. The personal information group is rquired for all events.', 'event_espresso'); ?></p>
...
<?php echo  __('Event End Date','event_espresso') . ' <input type="text" class="datepicker" size="15" id="end_date" name="end_date" value="' . $end_date . '" />'; ?></p>
			  ...
			  <?php echo event_espresso_timereg_editor($event_id);?>
			   ...
			   <p><strong><?php _e('Event Dates','event_espresso'); ?></strong><br /> 
