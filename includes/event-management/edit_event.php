    ...
    <strong><?php _e('Event Title','event_espresso'); ?></strong>
      ...
      <div class="inside">
        <div id="edit-slug-box"> <strong>
          ...
          <?php  echo '<a href="#" class="button" onclick="prompt(&#39;Event Short URL:&#39;, \'' . get_option('siteurl') . '/?ee=' . $event_id . '\'); return false;">' . __('Short URL') . '</a>'?>
          <?php  echo '<a href="#" class="button" onclick="prompt(&#39;Event Full URL:&#39;, \'' . get_option('siteurl') . '/?page_id=' . $org_options['event_page_id'] . '&amp;regevent_action=register&amp;event_id=' . $event_id . '\'); return false;">' . __('Full URL') . '</a>'?>
        </div>
      </div>
      <!-- /edit-slug-box --> 
    </div>
