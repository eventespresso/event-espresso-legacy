...
function edit_event($event_id = 0){
	...
	foreach ($events as $event){
		...
		$reg_limit_display = $event->reg_limit_display;
...
<div id="side-info-column" class="inner-sidebar">
  <div id="side-sortables" class="meta-box-sortables ui-sortable">
        ...
        <div class="submitbox" id="submitpost">
          <div id="minor-publishing">
            <div id="minor-publishing-actions">
              <div id="preview-action"> <a class="preview button" href="<?php echo get_option('siteurl')?>/?page_id=<?php echo $org_options['event_page_id']?>&regevent_action=register&event_id=<?php echo $event_id?>&name_of_event=<?php echo $event_name?>" target="event-preview" id="event-preview" tabindex="5">
   ...
   '<p><strong>' .__('Advanced Options:','event_espresso') . '</strong></p>' .
		...
		'<p>' .__('Use an off-site registration page?','event_espresso') . '<br />
...
?>
    ...
    <div style="display: block;" id="event-discounts" class="postbox">
      ...
      <div class="inside">
        ...
        <p>
          <?php _e('<strong>Allow discount codes?</strong> ','event_espresso');
...
<?php _e('Add a pre-populated <a href="admin.php?page=form_groups">group</a> of <a href="admin.php?page=form_builder">questions</a> to your event. The personal information group is rquired for all events.', 'event_espresso'); ?></p>
			...
			foreach ($q_groups as $question_group){
				...
				$group_name = $question_group->group_name;
					...
					echo '<p id="event-question-group-' . $group_id . '">
                                             <input value="' . $question_group_id . '" type="checkbox" ' . $visibility . ' name="question_groups[' . $question_group_id . ']" ' . $checked . ' /> <a href="admin.php?page=form_groups&amp;action=edit_group&amp;group_id=' . $question_group_id . '" title="edit">'. $group_name. "</a></p>";
			}
            ?>
      </div>
    </div>
...
<?php _e('Add a pre-populated <a href="admin.php?page=item_groups">group</a> of <a href="admin.php?page=cart_items">items</a> to your event.', 'event_espresso'); ?></p>
    ...
    <div id="normal-sortables" class="meta-box-sortables ui-sortable">
      <div style="display: block;" id="event-date-time" class="postbox">
        ...
        <table width="100%" border="0" cellpadding="5">
            ...
            ?>
                <tr><td colspan="2">
                        <div class="ui-state-highlight ui-corner-all">
                            ...
                            <?php _e( 'If you plan on making changes to Registration, Event, and Visibility Dates then <u>using the Recurring Event Manager is encouraged</u>. ', 'event_espresso' ); ?>
                        </p>
                    </div>
                </td></tr>
            <?php
            ...
            ?>
            <th align="left"><?php _e('Registration / Event Dates','event_espresso'); ?></th>
            <th align="left"><?php _e('Event Times','event_espresso'); ?></th>
...
<?php echo  __('Event End Date','event_espresso') . ' <input type="text" class="datepicker" size="15" id="end_date" name="end_date" value="' . $end_date . '" />'; ?></p>
                ...
                <?php /*?><p>
                    <br /> <?php echo __('Event Visible On:','event_espresso') . ' <input type="text" size="15" id="visible_on" class="datepicker" name="visible_on" value="' . $visible_on . '" />'; ?> <br />
                </p><?php */?>
              </td>
              <td><?php echo event_espresso_time_editor($event_id)?></td>
...
?>
          ...
          <table width="100%" border="0" cellpadding="5">
            ...
            <tr valign="top">
              ...
              <p>
                  ...
                  <input size="20"  type="text" tabindex="106" value="<?php echo $phone ?>" name="phone">
                </p>
               
              <p>
                  <?php _e('URL of Event:','event_espresso'); ?>
                  <br />
                  <textarea cols="30" rows="4" tabindex="107"  name="virtual_url"><?php echo $virtual_url ?></textarea>
                </p>
                <p>
                  <?php _e('Call in Number:','event_espresso'); ?>
                  <input size="20" tabindex="108"  type="text"  value="<?php echo $virtual_phone ?>" name="virtual_phone">
                </p></td>
            </tr>
          </table>
        </div>
      ...
      <!-- /event-location-->
        ...
        <div class="inside">
          ...
          <div id="emaildescriptiondivrich" class="postarea">
            ...
            <?php /*?><div style="float:right; width:150px;">
    ...
    <?php echo '<p>' . __('Add/Update post for this event?','event_espresso') . ' ' . select_input('create_post', $values, $create_post) . '</p>'; ?>
