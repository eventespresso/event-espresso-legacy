	...
	<?php _e('Registration Times', 'event_espresso'); ?>
							...
							<?php _e('Event Times', 'event_espresso'); ?>
								...
								<?php _e('Current Time', 'event_espresso'); ?>
										:</span> <span class="current-date"> <?php echo date_i18n(get_option('date_format')) . ' ' . date_i18n(get_option('time_format')); ?></span> <a class="change-date-time" href="options-general.php" target="_blank">
