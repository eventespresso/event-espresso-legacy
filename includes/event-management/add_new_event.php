...
<?php _e('Add a pre-populated <a href="admin.php?page=form_groups">group</a> of <a href="admin.php?page=form_builder">questions</a> to your event. The personal information group is rquired for all events.', 'event_espresso'); ?>
</p>
			...
			foreach ($q_groups as $question_group){
				...
				$question_group_description = $question_group->group_description;
					...
					echo '<p id="event-question-group-' . $group_id . '">
                                             <input value="' . $question_group_id . '" type="checkbox" ' . $checked . $visibility . ' name="question_groups[' . $question_group_id . ']" ' . $checked . ' /> <a href="admin.php?page=form_groups&amp;action=edit_group&amp;group_id=' . $question_group_id . '" title="edit">' . $group_name. '</a></p>';
			}
            ?>
      </div>
    </div>
            ...
            ?>
                <tr><td colspan="2">
                        <div class="ui-state-highlight ui-corner-all">
                            ...
                            <?php _e( 'If this is a recurring event, please use the Recurring Event Manager below for Registration, Event, and Visibility Dates.  <u>Do enter Start/End Times</u>. ', 'event_espresso' ); ?>
                        </p>
                    </div>
                </td></tr>
            <?php
...
<?php echo get_option( 'event_espresso_re_active' ) == 1? '' :'<p><a href="http://eventespresso.com/?p=3319" target="_blank">Recurring Event Manager Now Available!</a></p>'; ?>
              ...
              <td><?php echo event_espresso_time_editor()?></td>
