...
//Run the sql queries
	...
	$sql =" id int(11) unsigned NOT NULL AUTO_INCREMENT,
					  registration_id VARCHAR(23) DEFAULT NULL,
	...
	//Transactions database install
 	/*$table_name = "events_paypal_transactions";
	...
	$sql = "id int(11) NOT NULL AUTO_INCREMENT,
				  ...
				  PRIMARY KEY (id)";
	event_espresso_run_install ($table_name, $table_version, $sql);*/
	//Transactions database install end
	...
	$sql = "id int(11) unsigned NOT NULL AUTO_INCREMENT,
					  ...
					  UNIQUE KEY id (id)";
	event_espresso_run_install ($table_name, $table_version, $sql);
	//Category database install end

	//Event and Category database install
	...
	$sql = "id int(11) NOT NULL AUTO_INCREMENT,
						...
						PRIMARY KEY (id)";
	event_espresso_run_install ($table_name, $table_version, $sql);
	//Event and Category database install end

	//Event and Discount database install
	...
	$sql = "id int(11) NOT NULL AUTO_INCREMENT,
						...
						PRIMARY KEY (id)";
	event_espresso_run_install ($table_name, $table_version, $sql);
	//Event and Discount database install end
	...
	$sql = "id int(11) NOT NULL AUTO_INCREMENT,
                        ...
                        surcharge decimal(5,2) NOT NULL DEFAULT '0.00',
...
function events_organization_tbl_install () {
		...
		if($wpdb->get_var("SHOW TABLES LIKE '$table_name'") != $table_name) {
			...
			$payment_message=(__('<p>***This Is An Automated Response*** </p><p>Thank You [fname] [lname]</p>  <p>We have just  received a payment in the amount of $[event_price] for your registration to [event_name].</p> <p>PayPal transaction ID: [txn_id]</p>','event_espresso'));
		...
		//If an earlier version is found
			...
			foreach ($results as $result){
					...
					$events_listing_type =$result->events_listing_type;
...
//Organzization options install end
	...
	$sql = "id int(11) unsigned NOT NULL auto_increment,
			...
			bp_xprofile_id INT(11) NOT NULL,
			PRIMARY KEY  (id)";
	event_espresso_run_install ($table_name, $table_version, $sql);
	...
	$sql = "id int(11) NOT NULL AUTO_INCREMENT,
						...
						group_identifier VARCHAR(45) NOT NULL,
	...
	$sql = "registration_id varchar(23) NOT NULL,
...
function event_espresso_install_system_names(){
	...
	if ($phone == false)
        ...
        if ($wpdb->num_rows == 0){
            ...
            /**
             * Add new group, find id, assign the three system questions to the group
             */
            ...
            $new_group_id = $wpdb->insert_id;
                    ...
                    /**
                     * Find fname, lname, and email ids.  At this point, they will be in the system
                     */
                    ...
                    foreach ($system_names as $system_name){
                         ...
                         $wpdb->insert( $wpdb->prefix . "events_qst_group_rel", array('group_id' => $new_group_id, 'question_id' => $system_name->id), array('%d', '%d') );
