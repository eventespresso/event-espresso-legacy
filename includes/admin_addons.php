...
<div id="event_reg_theme" class="wrap">
  ...
  <div class="metabox-holder">
    <div class="postbox">
      ...
      <ul>
      <li><?php _e('Did your site get featured on <a href="http://www.groupon.com/" target="_blank">Groupon.com</a>? Now you can easily accept Groupon codes to your events! Once installed, just upload all of your Groupon codes to the database and your ready to go. How easy is that?','event_espresso'); ?></li>
        ...
        <li><?php _e('<a href="http://www.groupon.com/" target="_blank">Groupon</a> is a deal-of-the-day website that is localized to major markets in the United States. The first market for Groupon was Chicago, followed soon thereafter by Boston and New York City. As of January 2010, Groupon serves more than 40 markets. Groupon debuted in November 2008 as part of The Point, a platform for collective action.','event_espresso'); ?></li>
        
        <?php	
	if (file_exists(WP_PLUGIN_DIR . '/espresso-groupons/espresso-groupons.php')){
		echo '<li>';
		echo '<strong style="padding:5px;" class="green_alert">' . __('Installed','event_espresso') . '</strong>';
		echo is_plugin_active('espresso-groupons/espresso-groupons.php') ? ' <strong style="padding:5px;" class="green_alert">' . __('Active','event_espresso') . '</strong>' : ' <strong style="padding:5px;" class="red_alert">' . __('Not Active','event_espresso') . '</strong>';
		echo '</li>';
	}else{
		echo '<li><a href="https://www.e-junkie.com/ecom/gb.php?c=cart&i=AERPRO-GROUPON&cl=113214&ejc=2" target="ej_ejc" class="ec_ejc_thkbx" onClick="javascript:return EJEJC_lc(this);"><img src="' . EVENT_ESPRESSO_PLUGINFULLURL . '/images/add-to-cart.gif" border="0" alt="Add to Cart"/></a> <a href="https://www.e-junkie.com/ecom/gb.php?c=cart&cl=113214&ejc=2" target="ej_ejc" class="ec_ejc_thkbx" onClick="javascript:return EJEJC_lc(this);"><img src="' . EVENT_ESPRESSO_PLUGINFULLURL . '/images/checkout-button.gif" border="0" alt="View Cart"/></a></li>';
	}
?>
      </ul>
    </div>
  ...
  <div class="metabox-holder">
	...
	if (file_exists(WP_PLUGIN_DIR . '/espresso-members/espresso-members.php')){
		echo '<li>';
		echo '<strong style="padding:5px;" class="green_alert">' . __('Installed','event_espresso') . '</strong>';
		echo is_plugin_active('espresso-members/espresso-members.php') ? ' <strong style="padding:5px;" class="green_alert">' . __('Active','event_espresso') . '</strong>' : ' <strong style="padding:5px;" class="red_alert">' . __('Not Active','event_espresso') . '</strong>';
		echo '</li>';
	}else{
		echo '<li><a href="https://www.e-junkie.com/ecom/gb.php?c=cart&i=AERPRO-MEM-ADDON&cl=113214&ejc=2" target="ej_ejc" class="ec_ejc_thkbx" onClick="javascript:return EJEJC_lc(this);"><img src="' . EVENT_ESPRESSO_PLUGINFULLURL . '/images/add-to-cart.gif" border="0" alt="Add to Cart"/></a> <a href="https://www.e-junkie.com/ecom/gb.php?c=cart&cl=113214&ejc=2" target="ej_ejc" class="ec_ejc_thkbx" onClick="javascript:return EJEJC_lc(this);"><img src="' . EVENT_ESPRESSO_PLUGINFULLURL . '/images/checkout-button.gif" border="0" alt="View Cart"/></a></li>';
	}
?>
      </ul>
    </div>
  ...
  <div class="metabox-holder">
    <div class="postbox">
      <h3>
        <?php _e('Authorize.net SIM Gateway','event_espresso'); ?>
      </h3>
      <ul>
        <?php	
		echo '<li>If you already have a Merchant Account at your bank which allows you to authorize card accounts for direct payment into your bank account, then Authorize.Net would be the online equivalent of your in-store card-swipe/keypad terminal for card payment authorizations.</li>';
	
	if (file_exists(EVENT_ESPRESSO_GATEWAY_DIR . "/authnet/settings.php")){
		//_e('<h2 style="color:green">Installed</h2>','event_espresso');
		echo '<li>';
		echo '<strong style="padding:5px;" class="green_alert">' . __('Installed','event_espresso') . '</strong>';
		echo get_option('events_authnet_active') == 'true' ? ' <strong style="padding:5px;" class="green_alert">' . __('Active','event_espresso') . '</strong>' : ' <strong style="padding:5px;" class="red_alert">' . __('Not Active','event_espresso') . '</strong>';
		echo '</li>';
	}else{
		echo '<li><a href="https://www.e-junkie.com/ecom/gb.php?c=cart&i=AERPRO-AUTHNET-SIM-GTWY&cl=113214&ejc=2" target="ej_ejc" class="ec_ejc_thkbx" onClick="javascript:return EJEJC_lc(this);"><img src="' . EVENT_ESPRESSO_PLUGINFULLURL . '/images/add-to-cart.gif" border="0" alt="Add to Cart"/></a> <a href="https://www.e-junkie.com/ecom/gb.php?c=cart&cl=113214&ejc=2" target="ej_ejc" class="ec_ejc_thkbx" onClick="javascript:return EJEJC_lc(this);"><img src="' . EVENT_ESPRESSO_PLUGINFULLURL . '/images/checkout-button.gif" border="0" alt="View Cart"/></a></li>';
