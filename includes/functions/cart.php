...
<div class = "event_espresso_form_wrapper">
	<form id="event_espresso_checkout_form" method="post" action="?page_id=<?php echo $org_options['event_page_id']; ?>&regevent_action=post_multi_attendee">
		<?php
					$err = '';
					$edit_cart_link = '<a href="?page_id='.$org_options['event_page_id'].'&regevent_action=show_shopping_cart" rel="nofollow" class="'.espresso_template_css_class('btn_event_form_submit','btn_event_form_submit inline-link', false).'">'.__('Edit Cart', 'event_espresso').'</a>';
		...
		<?php } ?> 
				<p id="event_espresso_edit_cart" class="<?php espresso_template_css_class('event_espresso_edit_cart','event_espresso_edit_cart'); ?>">
					<a href="?page_id=<?php echo $org_options['event_page_id']; ?>&regevent_action=show_shopping_cart" class="<?php espresso_template_css_class('btn_event_form_submit','btn_event_form_submit inline-link'); ?>">
