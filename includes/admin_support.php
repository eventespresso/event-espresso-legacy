...
<div id="icon-options-event" class="icon32"></div><h2><?php _e('Help and Support', 'event_espresso'); ?></h2>
...
<h2><?php _e('Contact Support', 'event_espresso'); ?></h2>
</div>
<div class="box-mid-body" id="toggle1">
					<div class="padding">
<p><?php _e('If you are having any problems that are not discussed here, suggestions, comments or gripes please visit the', 'event_espresso'); ?> <a href="http://eventespresso.com/forums/"><?php _e('Event Espresso forums', 'event_espresso'); ?></a> <?php _e('or feel free to send us an', 'event_espresso'); ?> <a href="http://eventespresso.com/contact/"><?php _e('email', 'event_espresso'); ?></a>.</p>
		  </div>
</div></li>
<li>
<div class="box-mid-head">
<h2><?php _e('Settings', 'event_espresso'); ?></h2>
</div>
<div class="box-mid-body" id="toggle3">
					<div class="padding">
<p>To use, create a new page with only  [ESPRESSO_EVENTS]</p>
<p><span class="red_text">*</span><?php _e('For URL link back to the payment/thank you page use', 'event_espresso'); ?>  [ESPRESSO_PAYMENTS] <?php _e('on a new page', 'event_espresso'); ?>.</p>
<p><span class="red_text">*</span><?php _e('For PayPal to notify about payment confirmation use', 'event_espresso'); ?>  [ESPRESSO_TXN_PAGE] <?php _e('on a new page', 'event_espresso'); ?>.</p>
<p><?php _e('To display a single event on a page use the', 'event_espresso'); ?> [SINGLEEVENT single_event_id=&quot;Unique Event ID&quot;]</p>
<p><?php _e('To display list of attendees of an active event use', 'event_espresso'); ?> [LISTATTENDEES] <?php _e('on a page or post', 'event_espresso'); ?>.</p>
<p><?php _e('To display a list of events in sidebar, use the Event Registration Widget. If your theme doesn\'t use widgets, you can use', 'event_espresso'); ?>  &lt;?php display_all_events(); ?&gt; <?php _e('in theme code', 'event_espresso'); ?>.</p>
<p><span class="red_text">*</span><?php _e('This page should be hidden from from your navigation menu. Exclude pages by using the &lsquo;Exclude Pages&rsquo; plugin from', 'event_espresso'); ?> <a href="http://wordpress.org/extend/plugins/exclude-pages/" target="_blank">http://wordpress.org/extend/plugins/exclude-pages/</a> <?php _e('or using the &lsquo;exclude&rsquo; parameter in your &lsquo;wp_list_pages&rsquo; template tag. Please refer to', 'event_espresso'); ?> <a href="http://codex.wordpress.org/Template_Tags/wp_list_pages" target="_blank">http://codex.wordpress.org/Template_Tags/wp_list_pages</a> <?php _e('for more inforamation about excluding pages', 'event_espresso'); ?>.</p>
<p> <?php _e('Email Confirmations<br />  For customized confirmation emails, the following tags can be placed in the email form and they will pull data from the database to include in the email.', 'event_espresso'); ?></p>
...
<li>
<div class="box-mid-head">
<h2><?php _e('Trouble Shooting and Frequently Asked Questions', 'event_espresso'); ?></h2>
</div>
<div class="box-mid-body" id="toggle3">
					<div class="padding">
<p><strong><?php _e('Registration Page Just Refreshes', 'event_espresso'); ?></strong><br />
<?php _e('Usually its because you need to point the &quot;Main registration page:&quot; (in the Organization Settings page) to whatever page you have the shortcode', 'event_espresso'); ?> [ESPRESSO_EVENTS] <?php _e('on', 'event_espresso'); ?>.</p>
<p><strong><?php _e('Problems After Upgrading', 'event_espresso'); ?></strong><br />
  <?php _e('If you have just upgraded  from  the free version of this plugin, your event dates, times, and categories may be out of order, missing, showing an error, or are wrong.  Pressing the &quot;Run Upgrade Script&quot; button below should fix all of these problems.', 'event_espresso'); ?></p>
<form action="<?php echo $_SERVER["REQUEST_URI"]?>" method="post" name="form" id="form">
 ...
 <p><?php _e('If you have clicked the button above and event dates that should be expired, are showing an error or seem to be out of order. Go into the &quot;<a href="admin.php?page=events">Event Management</a>&quot; page and click the &quot;Edit this Event&quot; button then click the &quot;Update Event&quot; button on each event that is displaying the wrong date(s). This process should fix the problem. If it doesn\'t then send a support request using the help and support button above.', 'event_espresso'); ?></p>
<?php
...
<p class="red_text"><strong><?php _e('Attendee Information is Outdated', 'event_espresso'); ?></strong></p>
     <p><?php _e('Due to recent changes in the way attendee information is handled, attendee data may appear to be missing from some events. In order to reassign attendees to events, please run the attendee update script by pressing the button below.', 'event_espresso'); ?></p>
     <form action="<?php echo $_SERVER["REQUEST_URI"]?>" method="post" name="form" id="form">
      <p>
