...
function event_espresso_support() {
	...
	<?php _e('For the latest installation instructions please visit:', 'event_espresso'); ?>
										<a href="http://eventespresso.com/wiki/installing-event-espresso/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=latest+installation+instructions<?php echo '+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url(); ?>&utm_campaign=help_support_tab" target="_blank">http://eventespresso.com/wiki/installing-event-espresso/</a></p>
								</div>
							</div>
						</div>
					</div>
	...
	<?php _e('StickerGiant.com', 'event_espresso'); ?>
										...
										<dt> <a href="http://eventespresso.com/contact/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=Add+a+Marketing+Resource<?php echo '+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url(); ?>&utm_campaign=help_support_tab" target="_blank">
...
<dd>Check our <a href="http://www.ivycat.com/web-design/portfolio/?referral=eventespresso.com" target="_blank">web design portfolio</a> for examples of our work. </dd>
										...
										<dt> <a href="http://eventespresso.com/contact/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=Become+a+Partner<?php echo '+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url(); ?>&utm_campaign=help_support_tab" target="_blank">
	...
	<?php _e('Hire a Developer', 'event_espresso'); ?>
							...
							<div class="inside">
								<div class="padding">
									...
									<dl id="hire_devs">
										<dt> <a href="http://jobs.eventespresso.com/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=Event+Espresso+Job+Board<?php echo '+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url(); ?>&utm_campaign=help_support_tab" target="_blank">
	...
	<?php _e('For more information, please visit:', 'event_espresso'); ?>
										<br />
										<a href="http://eventespresso.com/wiki/shortcodes-template-variables/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=Shortcodes+Help<?php echo '+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url(); ?>&utm_campaign=help_support_tab" target="_blank">http://eventespresso.com/wiki/shortcodes-template-variables/</a></p>
									<hr />
	...
	<?php _e('Attendee Listings', 'event_espresso'); ?>
										...
										<p>
	<?php _e('For more information about the attendee listing shortcodes and customizations. Please view the <a href="http://eventespresso.com/wiki/shortcodes-template-variables/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=Attendee+Listing+Shortcodes+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url().'&utm_campaign=help_support_tab">Attendee Listing Shortcodes</a> page.', 'event_espresso'); ?>
										</p>
									</div>
									<div class="shortcode-box">
										<h4>
	...
	<?php _e('Contact Support', 'event_espresso'); ?>
							...
							<div class="inside">
								<div class="padding">
									...
									<p>If your problems are not urgent, please post in our <a href="http://eventespresso.com/support/forums/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=Before+Contacting+Support<?php echo '+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url(); ?>&utm_campaign=help_support_tab" target="_blank">support forums</a>. If you need immediate help. Please purchase a support token below, at which time you can schedule time with a dedicated support tech or core developer.</p>
	...
	<?php _e('When requesting support. Please copy and paste the details displayed of the <a href="admin.php?page=support#details">Important Information</a> section above. This will help us determine potential problems with your server, WordPress installation, and/or the Event Espresso plugin. Please also include a list (or screenshot) of all <a href="plugins.php?plugin_status=active">active plugins</a>.', 'event_espresso'); ?>
									...
									<p>
	<?php _e('<strong>You can purchase support tokens</strong> on the <a href="http://eventespresso.com/product/priority-support-tokens/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=support+tokens+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url().'&utm_campaign=help_support_tab">Premium Support page</a>. Tokens can be purchased one at a time, or in blocks of three at a discount.', 'event_espresso'); ?>
									</p>
									<p>Support tokens can be used to schedule live support (phone or IM) or for priority e-mail support. See <a href="http://eventespresso.com/support/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=details+on+premium+support<?php echo '+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url(); ?>&utm_campaign=help_support_tab">details on premium support</a>.</p>
									<div class="support-tokens">
										<h6><a href="http://eventespresso.com/product/priority-support-tokens/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=1+Premium+Support+Token<?php echo '+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url(); ?>&utm_campaign=help_support_tab" target="_blank">1 Premium Support Token</a></h6>
									...
									<div class="support-tokens">
										<h6><a href="http://eventespresso.com/product/3-premium-support-tokens/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=3+Premium+Support+Tokens<?php echo '+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url(); ?>&utm_campaign=help_support_tab" target="_blank">3 Premium Support Tokens</a></h6>
	...
	<?php _e('Installation &amp; Consulting', 'event_espreso'); ?>
									...
									<div class="install-options">
										<h6><a href="http://eventespresso.com/product/basic-install/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=Basic+Install<?php echo '+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url(); ?>&utm_campaign=help_support_tab" target="_blank">Basic Install</a></h6>
									...
									<div class="install-options">
										<h6><a href="http://eventespresso.com/product/basic-install-with-configuration/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=Basic+Install+with+Configuration<?php echo '+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url(); ?>&utm_campaign=help_support_tab" target="_blank">Basic Install with Configuration</a></h6>
										<p>Includes configuration and testing Payment Gateway's .</p>
										<p class="support-prices"><span class="price">Price: $65.00 </span></p>
									</div>
									<div class="install-options">
										<h6><a href="http://eventespresso.com/product/consultation/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=Consulting+(1+hour)<?php echo '+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url(); ?>&utm_campaign=help_support_tab" target="_blank">Consulting (1 hour)</a></h6>
	...
	<?php _e('More information can be found here:', 'event_espresso'); ?>
												<br />
												<a href="http://eventespresso.com/wiki/how-to-set-up-paypal-ipn/?utm_source=ee_plugin_admin&utm_medium=link&utm_content=how-to-set-up-paypal-ipn<?php echo '+ee_version_'.EVENT_ESPRESSO_VERSION .'+ee_install_url_'.site_url(); ?>&utm_campaign=help_support_tab" target="_blank">http://eventespresso.com/wiki/how-to-set-up-paypal-ipn/</a></p>
										</dd>
										<dt>
