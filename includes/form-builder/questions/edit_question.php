			...
			<table class="form-table">
				<tbody>
					<tr>
						...
						<td>
		  				<input name="question" id="question" size="50" value="<?php echo htmlspecialchars( $question_name, ENT_QUOTES ); ?>" type="text">
						</td>
					</tr>
					<tr>
				...
				<tr id="add-question-values">
					...
					<td>
		  			<input name="values" id="values" size="50" value="<?php echo htmlspecialchars( $question_values, ENT_QUOTES ); ?>" type="text" />
					<br />
				...
				<tr>
					...
					<td>
						<input name="required_text" id="required_text" size="50" value="<?php echo htmlspecialchars( $required_text, ENT_QUOTES ); ?>" type="text" /><br />
