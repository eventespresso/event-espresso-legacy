...
function event_espresso_form_builder_insert(){
	...
	$required = $_POST['required'] ? 'Y':'N';
   	$sequence = $_POST['sequence'] ?  $_POST['sequence']:'0';
		if ($wpdb->query("INSERT INTO " . EVENTS_QUESTION_TABLE . " (question_type, question, response, required, sequence)"
				. " VALUES ('" . $question_type . "', '" . $question . "', '" . $question_values . "', '" . $required . "', " . $sequence . ")")){?>
