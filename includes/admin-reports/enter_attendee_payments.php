		...
		case 'payment':
			...
			if ( isset($_POST[ 'attendee_action' ]) && $_POST[ 'attendee_action' ] == 'post_payment' ){
				...
				if ( ! $primary_att ) {
					...
					$txn_type = isset($_POST[ 'txn_type' ]) ? $_POST[ 'txn_type' ] : apply_filters('filter_hook_event_espresso_enter_attendee_payments_require_txn_type', FALSE);
					$txn_id = isset($_POST[ 'txn_id' ]) ? $_POST[ 'txn_id' ] : apply_filters('filter_hook_event_espresso_enter_attendee_payments_require_txn_id', FALSE);
