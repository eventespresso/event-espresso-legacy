...
?>		
    <h2><?php _e( 'Edit Attendee Payment Record', 'event_espresso' ); ?></h2>
                    ...
                    <table width="100%" border="0">
                        ...
                        <tr>
                            <td valign="top">
                                ...
                                <li><label><?php _e( 'How Many People:', 'event_espresso' ); ?></label> <input type="text" name="quantity" size="45" value ="<?php echo $quantity; ?>" /></li>

                                <li><label><?php _e( 'Date Paid:', 'event_espresso' ); ?></label> <input type="text" name="payment_date" size="45" value ="<?php if ( $payment_date != "" )
                                                                                       {
                                                                                           echo $payment_date;
                                                                                       }
                                                                                       if ( $payment_date == "" )
...
<?php _e( 'Dear [fname] [lname], <p>Our records show that we have not received your payment of [cost] for [event_link].</p> <p>Please visit [payment_url] to view your payment options.</p><p>Sincerely,<br />' . $Organization = $org_options[ 'organization' ] . '</p>', 'event_espresso' ); ?>
                                                                                   </textarea> <br />
                                                                                   <p align="right"><strong><a class="ev_reg-fancylink" href="#custom_email_info"><?php _e( 'View Custom Email Tags', 'event_espresso' ); ?></a></strong></p>
                                                                                           ...
                                                                                           <p><strong><a href="admin.php?page=admin_reports&event_id=<?php echo $event_id; ?>&event_admin_reports=list_attendee_payments"><< Back to List</a></strong></p>
                                                                                       </div></div>
<?php
