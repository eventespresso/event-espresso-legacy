...
<td nowrap="nowrap"><?php echo $event_time ?></td>
 <?php if ( $ticketing_installed == true ) {?><td nowrap="nowrap"><?php echo $attended == 1?"Yes":"No";?></td><?php } ?>
      ...
      <?php
        ...
        <div style="clear:both; margin-bottom:30px;">
         	<input name="delete_customer" type="submit" class="button-secondary" id="delete_customer" value="<?php _e( 'Delete Attendee(s)', 'event_espresso' ); ?>" style="margin:10px 0 0 0;" onclick="return confirmDel	ete();" />
	<?php if ( $ticketing_installed == true ) {?>
		<input name="attended_customer" type="submit" class="button-secondary" id="attended_customer" value="<?php _e( 'Mark Attendee(s) Registration', 'event_espresso' ); ?>" style="margin:10px 0 0 10px;" />
			
		<input name="unattended_customer" type="submit" class="button-secondary" id="attended_customer" value="<?php _e( 'Unmark Attendee(s) Registration', 'event_espresso' ); ?>" style="margin:10px 0 0 10px;" />
	<?php } ?>
