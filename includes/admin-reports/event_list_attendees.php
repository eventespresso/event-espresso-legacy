	...
	<?php _e('Event Title', 'event_espresso'); ?>
      ...
      <?php
        if (isset($_REQUEST['event_id'])){
          $event_id_tag = '&event_id=' . $_REQUEST['event_id'];
         ?>
			  <a class="button-primary" style="margin:10px 0 0 20px;" href="#" onclick="window.location='<?php echo get_bloginfo('wpurl') . "/wp-admin/admin.php?event_espresso&amp;export=report&action=attendees&amp;type=csv".$event_id_tag; ?>'" title="<?php _e('Export Attendee Data to CSV', 'event_espresso'); ?>"><?php _e('Export Attendee Data to CSV', 'event_espresso'); ?></a><?php
