...
<div class="metabox-holder">
  ...
  <div class="postbox">
    ...
    <h3>
      ...
      <?php _e('Add a Discount Code','event_espresso'); ?>
      ...
      <ul>
        ...
        <li>
          ...
          <label>
            ...
            <?php _e('Discount Code','event_espresso'); ?>
        ...
        <li>
          ...
          <?php _e('Discount Code Description','event_espresso'); ?>
        ...
        <li>
          ...
          <p>
            ...
            <input class="button-primary" type="submit" name="Submit" value="<?php _e('Add New Discount Code','event_espresso'); ?>" id="add_new_discount" />
