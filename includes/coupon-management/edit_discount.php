...
<div class="metabox-holder">
  ...
  <div class="postbox">
    ...
    <h3>
      ...
      <?php _e('Edit Discount:','event_espresso'); ?>
      ...
      <ul>
        ...
        <li>
          ...
          <label><strong>
            ...
            <?php _e('Dicount Code:','event_espresso'); ?>
        ...
        <li>
          ...
          <p>
            ...
            <input class="button-primary" type="submit" name="Submit" value="<?php _e('Update Discount','event_espresso'); ?>" id="update_discount" />
