...
?>
    ...
    <form id="form1" name="form1" method="post" action="<?php echo get_option('siteurl')?>/?page_id=<?php echo $event_page_id?>">
        <p class="espresso_confirm_registration"><?php _e('Confirm Registration', 'event_espresso'); ?> <input type="submit" name="confirm" id="confirm" value="Submit" /> or <a href="javascript: history.go(-1)"><?php _e('Edit Your Details?', 'event_espresso'); ?></a></p>                      
