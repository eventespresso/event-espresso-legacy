            ...
            <table width="95%" border="0" id="event_espresso_attendee_verify">
              <tr>
               ...
               <tr>
                ...
                <td><span class="event_espresso_value"><?php echo $price_type == '' ? $display_cost : stripslashes_deep($price_type) . ' / ' .$display_cost; ?></span></td>
              </tr>
              <tr>
                <td><strong class="event_espresso_name">
                  <?php _e('Attendee Name:','event_espresso'); ?>
                  </strong></td>
                <td  valign="top"><span class="event_espresso_value"><?php echo stripslashes_deep($attendee_name)?> (<?php echo $attendee_email?>)
				<?php
