...
?>	
					<tr>
						...
						<td>
							<span class="<?php espresso_template_css_class('value','event_espresso_value'); ?>"><?php echo empty($price_type) ? $org_options['currency_symbol'] . number_format($final_price,2) : stripslashes_deep($price_type) . ' / ' .$org_options['currency_symbol'].number_format($final_price,2);?></span>
						</td>
					</tr>
<?php
				} else {
...
?>
				...
				<tr valign="top">
					...
					<td>
						<span class="<?php espresso_template_css_class('value','event_espresso_value'); ?>"><?php echo $display_cost;  //echo $event_discount_label;?></span>
					</td>
				</tr>
			</table>
