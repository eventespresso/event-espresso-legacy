...
?>
            ...
            <form action='?regevent_action=show_registration_page' method='post' id="event_espresso_shopping_cart">
    ...
    ?>
                <div class="multi_reg_container" style="" id ="multi_reg_container-<?php echo $r->id ?>">
            ...
            <div>
                <table>
                    <tr>
                        ...
                        <th> <label><label>Price</label></label></th>
                        <th> <label># of Attendees</label></th>
                    </tr>
                    <tr>
                    <td>
...
<?php _e( 'Enter Coupon Code ', 'event_espresso' ); ?>
    ...
    <div id="event_espresso_total_wrapper">
        ...
        <span id="event_total_price" class="event_total_price"></span>
        <a href="#" id="event_espresso_refresh_total">REFRESH TOTAL</a><span class="event_total_price" style="">
...
<?php _e( 'Total (' . $org_options['currency_symbol'] . '):', 'event_espresso' ); ?>
    ...
    <input type="submit" class="submit" name="Continue" id="event_espresso_continue_registration" value="Checkout" />
