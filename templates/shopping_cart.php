...
<?php
		...
		?>
				<div class="multi_reg_cart_block event-display-boxes <?php echo apply_filters('espresso_filter_hook_registration_css_event-display-boxes','ui-widget'); ?>"  id ="multi_reg_cart_block-<?php echo $r->id ?>">
		
					<h3 class="event_title <?php echo apply_filters('espresso_filter_hook_registration_css_event_title','ui-widget-header ui-corner-top'); ?>"><?php echo stripslashes_deep( $r->event_name ) ?> <span class="remove-cart-item <?php echo apply_filters('espresso_filter_hook_registration_css_remove-cart-item',''); ?>"> <img class="ee_delete_item_from_cart <?php echo apply_filters('espresso_filter_hook_registration_css_ee_delete_item_from_cart',''); ?>" id="cart_link_<?php echo $r->id ?>" alt="Remove this item from your cart" src="<?php echo EVENT_ESPRESSO_PLUGINFULLURL ?>images/icons/remove.gif" /> </span> </h3>
						<div class="event-data-display <?php echo apply_filters('espresso_filter_hook_registration_css_event-data-display','ui-widget-content ui-corner-bottom'); ?>">
							<table id="cart-reg-details" class="event-display-tables <?php echo apply_filters('espresso_filter_hook_registration_css_event-display-tables','ui-widget-content ui-corner-bottom'); ?>">
								<thead>
									<tr>
...
//		printr( $_SESSION, '$_SESSION  <br /><span style="font-size:10px;font-weight:normal;">' . __FILE__ . '<br />line no: ' . __LINE__ . '</span>', 'auto' );
		?>
		<div class="event-display-boxes <?php echo apply_filters('espresso_filter_hook_registration_css_event-display-boxes','ui-widgetevent-display-tables'); ?> ">
			...
			<div id="event_espresso_coupon_wrapper" class="clearfix event-data-display <?php echo apply_filters('espresso_filter_hook_registration_css_coupon_wrapper',''); ?>">
				<label class="coupon-code <?php echo apply_filters('espresso_filter_hook_registration_css_coupon-code',''); ?>" for="event_espresso_coupon_code"><?php _e( 'Enter Coupon Code ', 'event_espresso' ); ?></label>
				<input type="text" 
			...
			<div id="event_espresso_coupon_wrapper <?php echo apply_filters('espresso_filter_hook_registration_css_coupon_wrapper',''); ?>" class="clearfix event-data-display" >
				<label class="coupon-code <?php echo apply_filters('espresso_filter_hook_registration_css_coupon-code',''); ?>" for="event_espresso_groupon_code"><?php _e( 'Enter Voucher Code ', 'event_espresso' ); ?></label>
				<input type="text" 
			...
			<div id="event_espresso_total_wrapper" class="clearfix event-data-display <?php echo apply_filters('espresso_filter_hook_registration_css_total_wrapper',''); ?>">					
				<?php do_action( 'action_hook_espresso_shopping_cart_before_total' ); ?>				
				<span class="event_total_price <?php echo apply_filters('espresso_filter_hook_registration_css_total_price',''); ?>">
