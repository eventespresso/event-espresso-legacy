<div class="espresso_payment_overview">
                ...
                <?php echo ($payment_date =='' || ($payment_status == 'Pending' && (espresso_payment_type($txn_type) == 'Invoice' || espresso_payment_type($txn_type) == 'Cash/Check')))?'':'<p><strong>'.__('Payment Date:', 'event_espresso').'</strong> '.event_date_display($payment_date).'</p>'; ?>
