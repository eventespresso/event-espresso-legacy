...
<div class="<?php echo apply_filters('espresso_filter_hook_css_event_display_boxes','event-display-boxes ui-widget'); ?>">
		...
		<h2 class="<?php echo apply_filters('espresso_filter_hook_css_event_title','event_title ui-widget-header ui-corner-top'); ?>">
	...
	<?php echo $event_name . $event_status?></h2>
		...
		<?php //echo wpautop($event_desc); ?>
			<ol class="<?php echo apply_filters('espresso_filter_hook_css_attendee_list','attendee_list'); ?>">
				<?php
				...
				?>
						<li class="<?php echo apply_filters('espresso_filter_hook_css_attendee_details','attendee_details'); ?>"> <span class="<?php echo apply_filters('espresso_filter_hook_css_espresso_attendee','espresso_attendee'); ?>"><?php echo $gravatar ?><?php echo stripslashes_deep($fname . ' ' . $lname) . $city_state .'</p>'; ?> </span>
							<div class="clear"></div>
						</li>
				<?php
					}
