...
<div class="event-display-boxes <?php echo apply_filters('espresso_filter_hook_event_list_css_event-display-boxes','ui-widget'); ?>">

		<h2 class="event_title <?php echo apply_filters('espresso_filter_hook_event_list_css_event_title','ui-widget-header ui-corner-top'); ?>">
	<?php _e('Attendee Listing For: ','event_espresso'); ?>
	<?php echo $event_name . $event_status?></h2>

		<div class="event-data-display <?php echo apply_filters('espresso_filter_hook_event_list_css_event-data-display','ui-widget-content ui-corner-bottom'); ?>">

		<?php //echo wpautop($event_desc); ?>
			<ol class="attendee_list <?php echo apply_filters('espresso_filter_hook_event_list_css_attendee_list',''); ?>">
				<?php
				...
				?>
						<li class="attendee_details <?php echo apply_filters('espresso_filter_hook_event_list_css_attendee_details',''); ?>"> <span class="espresso_attendee <?php echo apply_filters('espresso_filter_hook_event_list_css_espresso_attendee',''); ?>"><?php echo $gravatar ?><?php echo stripslashes_deep($fname . ' ' . $lname) . $city_state .'</p>'; ?> </span>
							<div class="clear"></div>
						</li>
				<?php
					}
