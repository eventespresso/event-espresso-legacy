...
<div id="event_espresso_registration_form">
    ...
    <h2 class="event_title" id="event_title-<?php echo $event_id; ?>"><?php echo "Event $event_counter: " . $event_name ?> <?php echo $is_active['status'] == 'EXPIRED' ? ' - <span class="expired_event">Event Expired</span>' : ''; ?> </h2>
    ...
    <select id='<?php echo "event_espresso_copy_data-$event_id";?>' class="event_espresso_copy_info">
        ...
        foreach ( $events_in_session as $k => $v ) {
            if($k != $event_id){
            echo "<option value='$k|$event_id'>" . "Same as Event $i: " . $v['event_name'] . "</option>";
            }
            $i++;
        }
        ?>
...
//print_r( event_espresso_get_is_active($event_id));
        ...
        <?php
                    ...
                    echo event_espresso_add_question_groups( $question_groups, $events_in_session, $event_id, 1 );
