...
?>
		<p id="available_spaces-<?php echo $event_id?>"><?php _e('Available Spaces:','event_espresso')?> <?php echo get_number_of_attendees_reg_limit($event_id, 'available_spaces')?></p>
				...
				<p id="register_link-<?php echo $event_id?>">
                            ...
                            <!--or <a class="<?php echo $registration_cart_class ?>" id="cart_link_<?php echo $event_id?>" href="<?php echo $registration_cart_url; ?>" title="<?php echo stripslashes_deep($event_name)?>"><?php echo $registration_cart_anchor; ?></a>-->
