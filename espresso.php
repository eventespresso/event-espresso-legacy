		...
		ob_start();
			if ($_REQUEST['regevent_action'] == "post_attendee"){
				...
				register_attendees();
                            ...
                            //This is the form page for registering the attendee
                            if (file_exists(EVENT_ESPRESSO_TEMPLATE_DIR."multi_registration_cart.php")){
                                    require_once(EVENT_ESPRESSO_TEMPLATE_DIR."multi_registration_cart.php");//This is the path to the template file if available
                            }else{
                                    require_once("templates/multi_registration_cart.php");
                            }
...
//Export PDF Ticket
if (isset($_REQUEST['downlaod_ticket'])){
