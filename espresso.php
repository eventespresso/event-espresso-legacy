...
if (isset($_REQUEST['export'])){
	switch ($_REQUEST['export']) {
	 case "report";
		...
		$sql_x = "SELECT id, event_name, event_desc, event_identifier, question_groups FROM " . EVENTS_DETAIL_TABLE;
