...
{
	$_SESSION['espresso_session_id'] = (mt_rand(100,999).time());
}
...
add_action('the_content','event_espresso_insert');
add_action('the_content','event_espresso_pay_insert');
add_action('the_content','event_espresso_txn_insert');
