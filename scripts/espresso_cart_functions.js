...
jQuery(document).ready(function() {
    ...
    jQuery('.ee_delete_item_from_cart').click(function(){
        ...
        var data = {
            ...
            main_container : jQuery(this).parents('.multi_reg_container')
    ...
    jQuery('#event_espresso_shopping_cart :input[id^="price_option-"], .attendee_quantitiy, #event_espresso_coupon_code ').change(function(){
